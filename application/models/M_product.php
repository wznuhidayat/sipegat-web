...
class M_product extends CI_Model{
    ...
    {
        return $this->db->get_where($this->_table, ["kode_product" => $id])->row();
    }
    ...
    public function save()
    {
        ...
        $this->kode_product = floor(microtime(true)*321);
        $this->name = $post["name"];
        // if ($ven != null) {
        //     $this->id_vendor = $ven;
        // }else{
    ...
    public function update()
    {
        ...
        $this->detail = $post["detail"];
        $this->db->update($this->_table, $this, array('kode_product' => $post['id']));
    }

    public function delete($id)
    {
        $this->_deleteImage($id);
        return $this->db->delete($this->_table, array("kode_product" => $id));
    }
